...
import com.example.myapp.di.DatabaseModule_ProvideDatabaseFactory;
import com.example.myapp.di.DatabaseModule_ProvideUserDaoFactory;
import com.example.myapp.presentation.main.MainActivity;
import com.example.myapp.presentation.main.MainActivity_MembersInjector;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectUserDao(instance, singletonCImpl.userDao());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements dagger.internal.Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.myapp.data.local.AppDatabase 
